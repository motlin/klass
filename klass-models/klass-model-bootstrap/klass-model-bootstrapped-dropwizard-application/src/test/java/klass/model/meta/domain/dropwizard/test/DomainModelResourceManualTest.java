...
public class DomainModelResourceManualTest
{
    @ClassRule
    ...
    @Test
    public void metaDomainModel() throws JSONException
    {
        Client client = this.getClient(
                "klass.model.meta.domain.dropwizard.test.DomainModelResourceManualTest.metaDomainModel");
