...
public class MetaResourceManualTest
{
    ...
    public void metaAssociation() throws JSONException
    {
        ...
        String expected = ""
                ...
                + "  ],\n"
                + "  \"criteria\": {\n"
                + "    \"_type\": \"klass.model.meta.domain.OperatorCriteria\",\n"
                + "    \"operator\": \"==\",\n"
                + "    \"sourceExpressionValue\": {\n"
                + "      \"_type\": \"klass.model.meta.domain.ThisMemberReferencePath\",\n"
                + "      \"klass\": {\n"
                + "        \"name\": \"Classifier\",\n"
                + "        \"packageName\": \"klass.model.meta.domain\"\n"
                + "      },\n"
                + "      \"associationEnds\": [],\n"
                + "      \"dataTypeProperty\": {\n"
                + "        \"_type\": \"klass.model.meta.domain.PrimitiveProperty\",\n"
                + "        \"name\": \"name\",\n"
                + "        \"primitiveType\": \"String\"\n"
                + "      }\n"
                + "    },\n"
                + "    \"targetExpressionValue\": {\n"
                + "      \"_type\": \"klass.model.meta.domain.TypeMemberReferencePath\",\n"
                + "      \"klass\": {\n"
                + "        \"name\": \"ClassifierInterfaceMapping\",\n"
                + "        \"packageName\": \"klass.model.meta.domain\"\n"
                + "      },\n"
