...
public class MetaResourceManualTest
{
    ...
    public void metaClass() throws JSONException
    {
        ...
        String expected = ""
                ...
                + "      \"inferred\": false,\n"
                + "      \"ordinal\": 2,\n"
                + "      \"sourceCode\": \"dataTypeProperties            : DataTypeProperty[0..*] owned\\n        orderBy: this.ordinal;\",\n"
                + "      \"sourceCodeWithInference\": \"dataTypeProperties            : DataTypeProperty[0..*] owned\\n        orderBy: this.ordinal;\",\n"
                + "      \"direction\": \"target\",\n"
                + "      \"multiplicity\": \"0..*\",\n"
                + "      \"owningClass\": {\n"
                + "        \"name\": \"Classifier\",\n"
                ...
                + "      \"inferred\": false,\n"
                + "      \"ordinal\": 2,\n"
                + "      \"sourceCode\": \"enumerationProperties: EnumerationProperty[0..*] owned\\n        orderBy: this.ordinal;\",\n"
                + "      \"sourceCodeWithInference\": \"enumerationProperties: EnumerationProperty[0..*] owned\\n        orderBy: this.ordinal;\",\n"
                + "      \"direction\": \"target\",\n"
                + "      \"multiplicity\": \"0..*\",\n"
                + "      \"owningClass\": {\n"
                + "        \"name\": \"Classifier\",\n"
                ...
                + "      \"inferred\": false,\n"
                + "      \"ordinal\": 2,\n"
                + "      \"sourceCode\": \"primitiveProperties: PrimitiveProperty[0..*] owned\\n        orderBy: this.ordinal;\",\n"
                + "      \"sourceCodeWithInference\": \"primitiveProperties: PrimitiveProperty[0..*] owned\\n        orderBy: this.ordinal;\",\n"
                + "      \"direction\": \"target\",\n"
                + "      \"multiplicity\": \"0..*\",\n"
                + "      \"owningClass\": {\n"
                + "        \"name\": \"Classifier\",\n"
