...
public class ClassifierResourceManualTest
{
    ...
    @Test
    public void metaGetAll() throws JSONException
    {
        Client client = this.getClient(
                "klass.model.meta.domain.dropwizard.test.ClassifierResourceManualTest.metaGetAll");
