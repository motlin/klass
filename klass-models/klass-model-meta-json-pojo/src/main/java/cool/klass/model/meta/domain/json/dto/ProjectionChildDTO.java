...
@JsonSubTypes(
        {
                @Type(
                        ...
                        name = "klass.model.meta.domain.ProjectionDataTypePropertyDTO"),
                @Type(
                        value = ProjectionReferencePropertyDTO.class,
                        name = "klass.model.meta.domain.ProjectionReferencePropertyDTO"),
                @Type(
                        value = ProjectionProjectionReferenceDTO.class,
                        name = "klass.model.meta.domain.ProjectionProjectionReferenceDTO"),
        })
