...
public class ServiceResourceGeneratorTest
{
    ...
    public void stackOverflow()
    {
        ...
        String expectedSourceCode = ""
                ...
                + "        Projection projection = domainModel.getProjectionByName(\"QuestionReadProjection\");\n"
                ...
                + "        MithraObject mithraObject = Iterate.getOnly(result);\n"
                + "\n"
                + "        Projection projection = domainModel.getProjectionByName(\"QuestionWriteProjection\");\n"
                + "        return new ReladomoJsonTree(mithraObject, projection.getProjectionMembers());\n"
                + "    }\n"
                + "\n"
                + "    @DELETE\n"
                ...
                + "    @Path(\"/api/question\")\n"
                + "    @Produces(MediaType.APPLICATION_JSON)\n"
                + "    public ReladomoJsonTree method6()\n"
                + "    {\n"
