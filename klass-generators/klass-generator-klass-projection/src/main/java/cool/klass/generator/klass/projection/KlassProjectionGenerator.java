...
public class KlassProjectionGenerator
{
    ...
    private void writeFile(Pair<String, RichIterable<Classifier>> packagePair, Path outputPath)
    {
        String                   fullyQualifiedPackage = packagePair.getOne();
        RichIterable<Classifier> classifiers           = packagePair.getTwo();

        Path   klassOutputPath      = this.getOutputPath(outputPath, fullyQualifiedPackage);
        String projectionSourceCode = this.getClassifierSourceCode(classifiers, fullyQualifiedPackage);
    ...
    @Nonnull
    private String getClassifierSourceCode(
            @Nonnull RichIterable<Classifier> classifiers,
            @Nonnull String fullyQualifiedPackage)
    {
