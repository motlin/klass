...
public class UrlFilterFactoryTest
{
    ...
    private final JsonConfigurationFactory<UrlFilterFactory> factory = new JsonConfigurationFactory<>(
            UrlFilterFactory.class,
            this.validator,
            this.objectMapper,
            "dw");
    ...
    public void isDiscoverable()
    {
        ...
        assertThat(discoveredSubtypes, hasItem(UrlFilterFactory.class));
    }
    ...
    public void filterUrl() throws Exception
    {
        ...
        UrlFilterFactory     urlFilterFactory = this.factory.build(yml);
        ...
        assertThat(urlFilterFactory, instanceOf(UrlFilterFactory.class));
