...
public class FirebaseAuth
{
    ...
    public FirebaseAuth(String firebaseCredentialsClasspathLocation, String databaseUrl)
    {
    ...
    {
        InputStream firebaseCredentials = FirebaseAuth.class.getResourceAsStream(
                this.firebaseCredentialsClasspathLocation);
        Objects.requireNonNull(firebaseCredentials, this.firebaseCredentialsClasspathLocation);
