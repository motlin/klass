...
public class PropertiesOptionalTest extends AbstractPrimitiveValidatorTest
{
    ...
    public void validate_expected_primitive_actual_array() throws IOException
    {
        ...
        ImmutableList<String> expectedErrors = Lists.immutable.with("Error at PropertiesOptional.propertiesOptionalId. Expected property with type 'PropertiesOptional.propertiesOptionalId: Long' but got '[]' with type 'array'.",
